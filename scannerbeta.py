...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.scan_aderyn_button = tk.Button(self.button_frame, text="Scan with Aderyn", command=self.scan_with_aderyn)
        self.scan_aderyn_button.pack(side=tk.LEFT, padx=5)
